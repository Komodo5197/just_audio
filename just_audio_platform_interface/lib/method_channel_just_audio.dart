...
class MethodChannelJustAudio extends JustAudioPlatform {
  ...
  Future<AudioPlayerPlatform> init(InitRequest request) async {
    ...
    return MethodChannelAudioPlayer(request.id, request.resolverCallback, request.mappingCallback);
  }
...
class MethodChannelAudioPlayer extends AudioPlayerPlatform {
  ...
  final MappingAudioSourceCallback _mapper;

  MethodChannelAudioPlayer(String id, URIResolverCallback resolver, MappingAudioSourceCallback mapper)
  ...
  Future<Object?> _methodCallHandler(MethodCall call) async {
    switch (call.method) {
      case 'createMappedAudioSourceSource':
        ...
        final message = await _mapper(id);
  ...
  Future<SetAutomaticallyWaitsToMinimizeStallingResponse> setAutomaticallyWaitsToMinimizeStalling(
    ...
    return SetAutomaticallyWaitsToMinimizeStallingResponse.fromMap((await _channel.invokeMethod<Map<dynamic, dynamic>>(
